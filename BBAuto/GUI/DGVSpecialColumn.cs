...
namespace BBAuto
{
    ...
    {
        private static readonly string[] notIncludeColumnsInFilter = new string[] { "Бортовой номер", "VIN", "№ ПТС", "№ СТС", "Пробег",
            "Дата последней записи о пробеге", "Комментарий", "№ накладной", "Начало", "Начало действия", "№ постановления", "Сумма штрафа",
            "№ ДК", "Сумма", "Согласование", "Файл", "№ дела", "Дата окончания гарантии", "Дата обращения в страховую компанию",
            "Сумма возмещения", "Примечание", "Обстоятельства ДТП (со слов участника)", "Повреждения", "№ убытка страховой" };

        private static readonly string[] applyFilterColumnsActual = new string[] { "Марка", "Модель", "Регион", "Год выпуска", "Собственник" };
