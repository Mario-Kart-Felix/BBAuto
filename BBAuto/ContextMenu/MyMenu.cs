...
namespace BBAuto
{
    public class MyMenu
    {
        ...
        public MenuStrip CreateMainMenu()
        {
            switch (User.GetRole())
            {
                case RolesList.Adminstrator: case RolesList.Boss: case RolesList.proxyBoss: case RolesList.Editor:
                    return CreateMainMenuAdministrator();
                case RolesList.AccountantWayBill:
                    return CreateMainMenuAccountantWayBill();
                case RolesList.Viewer: case RolesList.AccountantBBraun: case RolesList.AccountantGematek:
