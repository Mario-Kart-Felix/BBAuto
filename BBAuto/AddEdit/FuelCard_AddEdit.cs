...
namespace BBAuto
{
    public partial class FuelCard_AddEdit : Form
    {
        ...
        private void Save()
        {
            ...
            {
                MessageBox.Show("Не удалось сохранить топливную карту. Не выбран элемент из списка", "Ошибка", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        {
            if (MessageBox.Show("Удалить запись о водителе?", "Удаление", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == System.Windows.Forms.DialogResult.Yes)
            {
                int idFuelCardDriver = GetFuelCardDriverID();
        ...
        private void LeaveTextBox()
        {
            ...
            tbNumber.Text = (cbFuelCardType.SelectedValue.ToString() == "1") ? tbNumber.Text.Insert(1, " ").Insert(5, " ").Insert(9, " ") : tbNumber.Text.Insert(6, " ").Insert(14, " ");
        }
    }
}